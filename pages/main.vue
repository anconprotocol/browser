      ...
      <v-row dense>
        <v-col cols="12">
          <v-card color="amber accent-4" dark>
            ...
            <v-card-subtitle
              >Decentralized digital assets and services.</v-card-subtitle
            >

            <v-card-actions>
              <v-btn text> 21 Dapps, 80 NFTs, 5 alert topics </v-btn>
            </v-card-actions>
          </v-card>
        </v-col>
        ...
        <v-col cols="12">
          <v-card color="indigo accent-4" dark>
            ...
            <v-card-subtitle>Decentralized offchain messaging.</v-card-subtitle>

            <v-card-actions>
              <v-btn text> 16 groups (11 encrypted, 5 open) </v-btn>
            </v-card-actions>
          </v-card>
        </v-col>
        <v-col cols="12">
          <v-card color="blue-grey accent-4" dark>
            ...
            <v-card-actions>
              <v-btn text> 1001 assets, 10 credentials </v-btn>
            </v-card-actions>
          </v-card>
        </v-col>
      </v-row>
